...
public class TestInformedPlayerInstance  implements Player{
	...
	public TestInformedPlayerInstance() {
		super();
	}

	public TestInformedPlayerInstance(String name, IntermediateGameState intermediateGameState, int ownDiscardPileThreshold, int ownDiscardPileIncreamentFactor,
